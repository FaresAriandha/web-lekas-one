...
@section('content')
    <div class="bg-white shadow rounded-2xl p-6 flex flex-col" id="container-table">
        ...
        <form class="w-full flex justify-between items-start mb-4 flex-col sm:flex-col"
            action="{{ route('admin.prices.update', $price->spl_ID) }}" method="post">
            @csrf
            @method('PUT')
            {{-- Baris 1 --}}
            <div
                ...
                <div class="w-full">
                    ...
                    <div class="relative">
                        <input type="text" id="spl_name" aria-describedby="helper-text-explanation"
                            ...
                            value="{{ old('spl_name', $price->spl_name) }}">
                        @error('spl_name')
                ...
                <div class="w-full">
                    ...
                    <div
                        ...
                        <select
                            ...
                            <option value="pasjay" {{ old('spl_type', $price->spl_type) == 'pasjay' ? 'selected' : '' }}>
                                Pasar Jaya
                            </option>
                            <option value="paxel" {{ old('spl_type', $price->spl_type) == 'paxel' ? 'selected' : '' }}>
                                Paxel
                            </option>
                        </select>
                ...
                <div class="w-full">
                    ...
                    <div class="relative">
                        <input type="number" id="spl_baseprice" aria-describedby="helper-text-explanation"
                            ...
                            value="{{ old('spl_baseprice', $price->spl_baseprice) }}">
                        @error('spl_baseprice')
                            <p class="mt-2 text-sm text-red-500">
                                {{ $message }}
                            </p>
                ...
                <div class="w-full">
                    ...
                    <div class="relative">
                        <input type="number" id="spl_baseprice_client" aria-describedby="helper-text-explanation"
                            ...
                            maxlength="10" value="{{ old('spl_baseprice_client', $price->spl_baseprice_client) }}">
                ...
                <div class="w-full">
                    ...
                    <div class="relative">
                        <input type="number" id="spl_multidrop" aria-describedby="helper-text-explanation"
                            ...
                            value="{{ old('spl_multidrop', $price->spl_multidrop) }}">
                        @error('spl_multidrop')
                            <p class="mt-2 text-sm text-red-500">
                                {{ $message }}
                            </p>
                ...
                <div class="w-full">
                    ...
                    <div class="relative">
                        <input type="number" id="spl_multidrop_client" aria-describedby="helper-text-explanation"
                            ...
                            maxlength="10" value="{{ old('spl_multidrop_client', $price->spl_multidrop_client) }}">
                ...
                <div class="w-full">
                    ...
                    <div class="relative">
                        <input type="number" id="spl_roundtrip" aria-describedby="helper-text-explanation"
                            ...
                            value="{{ old('spl_roundtrip', $price->spl_roundtrip) }}">
                        @error('spl_roundtrip')
                            <p class="mt-2 text-sm text-red-500">
                                {{ $message }}
                            </p>
                ...
                <div class="w-full">
                    ...
                    <div class="relative">
                        <input type="number" id="spl_roundtrip_client" aria-describedby="helper-text-explanation"
                            ...
                            maxlength="10" value="{{ old('spl_roundtrip_client', $price->spl_roundtrip_client) }}">
