...
@section('content')
    <div class="bg-white shadow rounded-2xl p-6 flex flex-col" id="container-table">
        ...
        <form class="w-full flex justify-between items-start mb-4 flex-col sm:flex-col"
            action="{{ route('admin.assignees.store') }}" method="post">
            @csrf
            {{-- Baris 1 --}}
            <div
                ...
                <div class="w-full">
                    ...
                    <div
                        ...
                        <select
                            ...
                            <option value="pasjay" {{ old('cas_type') == 'pasjay' ? 'selected' : '' }}>
                                Pasar Jaya
                            </option>
                            <option value="paxel" {{ old('cas_type') == 'paxel' ? 'selected' : '' }}>
                                Paxel
                            </option>
                        </select>
            ...
            {{-- Baris 2 --}}
            <div class="w-full flex flex-col sm:flex-row justify-between items-start space-y-8 sm:space-y-0 mt-8">
                <div class="w-full sm:w-1/2">
                    ...
                    <div class="relative">
                        <input id="cas_pickup_time" date-rangepicker datepicker-autohide type="text"
                            class="datetimepicker border-0 ring-1 ring-[#344357] text-[#344357] text-sm rounded-lg focus:ring-2 focus:outline-none block w-full p-2.5 ps-10"
                            placeholder="Pilih tanggal & waktu" name="cas_pickup_time"
                            value="{{ old('cas_pickup_time', '') }}" autocomplete="off">
                ...
                <div class="w-full hidden">
                    ...
                    <div
                        ...
                        <select
                            ...
                            name="cas_status">
                            <option value="" disabled selected>Pilih Tipe</option>
                            <option value="Ditugaskan" {{ old('cas_status') == 'Ditugaskan' ? 'selected' : '' }}
                                class="hidden">Ditugaskan
                            </option>
                            <option value="Menuju Pickup" {{ old('cas_status') == 'Menuju Pickup' ? 'selected' : '' }}>
                                Menuju Pickup
                            </option>
                            <option value="Dalam Tugas" {{ old('cas_status') == 'Dalam Tugas' ? 'selected' : '' }}>Dalam
                                Tugas
                            </option>
                            <option value="Selesai" {{ old('cas_status') == 'Selesai' ? 'selected' : '' }}>Selesai
                            </option>
                        </select>
