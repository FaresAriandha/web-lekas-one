                ...
                <div class="w-full">
                    ...
                    <div class="relative">
                        <input type="number" id="courier_NIK" aria-describedby="helper-text-explanation"
                            ...
                            maxlength="16" value="{{ old('courier_NIK') }}">
                        @error('courier_NIK')
                            <p class="mt-2 text-sm text-red-500">
                                {{ $message }}
                            </p>
                ...
                <div class="w-full">
                    ...
                    <div class="relative">
                        <input type="number" id="courier_no_rekening" aria-describedby="helper-text-explanation"
                            ...
                            maxlength="10" value="{{ old('courier_no_rekening') }}">
                ...
                <div class="w-full">
                    ...
                    <div class="relative">
                        <input type="number" id="courier_telp" aria-describedby="helper-text-explanation"
                            ...
                            maxlength="15" value="{{ old('courier_telp') }}">
                        @error('courier_telp')
                            <p class="mt-2 text-sm text-red-500">
                                {{ $message }}
                            </p>
                ...
                <div class="w-full">
                    ...
                    <div class="relative">
                        <input type="number" id="courier_telp_darurat" aria-describedby="helper-text-explanation"
                            ...
                            maxlength="15" value="{{ old('courier_telp_darurat') }}">
