...
@section('content')
    <div class="bg-white shadow rounded-2xl p-6 flex flex-col" id="container-table">
        ...
        <form class="w-full flex justify-between items-start mb-4 flex-col sm:flex-col"
            action="{{ route('admin.couriers.update', $courier->courier_ID) }}" method="post"
                ...
                <div class="w-full">
                    ...
                    <div class="relative">
                        <input type="number" id="courier_NIK" aria-describedby="helper-text-explanation"
                            ...
                            max="9999999999999999" value="{{ old('courier_NIK', $courier->courier_NIK) }}">
                        @error('courier_NIK')
                            <p class="mt-2 text-sm text-red-500">
                                {{ $message }}
                            </p>
                ...
                <div class="w-full">
                    ...
                    <div class="relative">
                        <input type="text" id="courier_birthplace" aria-describedby="helper-text-explanation"
                            ...
                            maxlength="100" value="{{ old('courier_birthplace', $courier->courier_birthplace) }}">
                ...
                <div class="w-full">
                    ...
                    <div class="relative">
                        <input id="courier_birthdate" datepicker datepicker-autohide type="text"
                            ...
                            placeholder="Pilih tanggal" name="courier_birthdate"
                            value="{{ old('courier_birthdate', $courier_birthdate) }}" autocomplete="off">
                ...
                <div class="w-full">
                    ...
                    <div
                        ...
                        <select
                            ...
                            <option value="male"
                                {{ old('courier_gender', $courier->courier_gender) == 'male' ? 'selected' : '' }}>
                                Laki-laki
                            </option>
                            <option value="female"
                                {{ old('courier_gender', $courier->courier_gender) == 'female' ? 'selected' : '' }}>
                                Perempuan
                            </option>
                        </select>
                ...
                <div class="w-full">
                    ...
                    <div class="relative">
                        <textarea type="text" id="courier_address" aria-describedby="helper-text-explanation"
                            ...
                            placeholder="Jl. Lorem Ipsum No. 255" name="courier_address" autocomplete="off" data-char-count maxlength="255">{{ old('courier_address', $courier->courier_address) }}</textarea>
                ...
                <div class="w-full">
                    ...
                    <div class="relative">
                        <input type="text" id="courier_nama_rekening" aria-describedby="helper-text-explanation"
                            ...
                            maxlength="100" value="{{ old('courier_nama_rekening', $courier->courier_nama_rekening) }}">
            ...
            <div
                ...
                <div class="w-full box-border">
                    ...
                    <div class="relative ring-1 ring-[#344357] rounded-lg focus:ring-2 overflow-hidden">
                        <input
                            ...
                            name="courier_img_preview" accept="image/jpg, image/jpeg, image/png"
                ...
                <div class="w-full box-border">
                    ...
                    <div class="relative ring-1 ring-[#344357] rounded-lg focus:ring-2 overflow-hidden">
                        <input
                            class="border-0  text-[#344357] focus:outline-none block w-full px-2 box-border text-base font-semibold cursor-not-allowed"
                            aria-describedby="courier_docs_help" id="courier_docs_preview" type="text"
                            name="courier_docs_preview" accept="application/pdf"
                            value="{{ basename($courier->courier_docs) }}" disabled>
                        <button type="button"
                            class="absolute top-0 right-0 bg-yellow-300 text-black px-2 h-full cursor-pointer active:scale-105"
