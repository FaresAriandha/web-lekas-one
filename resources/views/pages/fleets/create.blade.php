...
@section('content')
    <div class="bg-white shadow rounded-2xl p-6 flex flex-col" id="container-table">
        ...
        <form class="w-full flex justify-between items-start mb-4 flex-col sm:flex-col"
            action="{{ route('admin.fleets.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            {{-- Baris 1 --}}
            <div
                ...
                <div class="w-full">
                    ...
                    <div
                        ...
                        <select
                            ...
                            <option value="Van" {{ old('fleet_type') == 'Van' ? 'selected' : '' }}>Van
                            </option>
                            <option value="Pickup" {{ old('fleet_type') == 'Pickup' ? 'selected' : '' }}>Pickup
                            </option>
                            <option value="CDE Box" {{ old('fleet_type') == 'CDE Box' ? 'selected' : '' }}>CDE Box
                            </option>
                        </select>
                ...
                <div class="w-full">
                    ...
                    <div class="relative">
                        <input type="text" id="fleet_merk" aria-describedby="helper-text-explanation"
                            ...
                            maxlength="100" value="{{ old('fleet_merk') }}">
                        @error('fleet_merk')
                            <p class="mt-2 text-sm text-red-500">
                                {{ $message }}
                            </p>
                ...
                <div class="w-full">
                    ...
                    <div class="relative">
                        <input id="fleet_KIR_date" datepicker datepicker-autohide type="text"
                            ...
                            placeholder="Pilih tanggal" name="fleet_KIR_date" value="{{ old('fleet_KIR_date', '') }}"
                            autocomplete="off">
                ...
                <div class="w-full">
                    ...
                    <div
                        ...
                        <select
                            ...
                            name="fleet_status">
                            <option value="" disabled selected>Pilih Tipe</option>
                            <option value="TERSEDIA" {{ old('fleet_status') == 'TERSEDIA' ? 'selected' : '' }}>Tersedia
                            </option>
                            <option value="DIGUNAKAN" {{ old('fleet_status') == 'DIGUNAKAN' ? 'selected' : '' }}>Digunakan
                            </option>
                            <option value="PERBAIKAN" {{ old('fleet_status') == 'PERBAIKAN' ? 'selected' : '' }}>Perbaikan
                            </option>
                        </select>
