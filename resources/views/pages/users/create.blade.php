...
@section('content')
    ...
    <ul class="text-sm font-medium text-center overflow-hidden rounded-lg shadow-md flex ">
        <li class="w-full focus-within:z-10">
            <a href="{{ route('admin.users.create', ['mode_insert' => 'not_courier']) }}"
                class="inline-block w-full p-4 {{ $mode_insert == 'not_courier' ? 'text-white bg-[#344357]' : 'text-[#344357]' }} focus:outline-none"
                aria-current="page">Not Courier</a>
        </li>
        <li class="w-full focus-within:z-10">
            <a href="{{ route('admin.users.create', ['mode_insert' => 'courier']) }}"
                class="inline-block w-full p-4 {{ $mode_insert == 'courier' ? 'text-white bg-[#344357]' : 'text-[#344357]' }} focus:outline-none"
                aria-current="page">Courier</a>
        </li>
    </ul>
    ...
    <div class="bg-white shadow rounded-2xl p-6 flex flex-col mt-[20px]" id="container-table">
        ...
        <form class="w-full flex justify-between items-start mb-4 flex-col sm:flex-col"
            ...
            {{-- Baris 1 --}}
            <div
                class="w-full flex flex-col sm:flex-row justify-between items-start space-y-8 sm:space-x-[40px] sm:space-y-0 {{ $mode_insert == 'courier' ? 'hidden' : '' }}">
                <div class="w-full ">
                ...
                <div class="w-full">
                    ...
                    <div
                        ...
                        <select
                            ...
                            <option value="korlap" {{ old('user_role') == 'korlap' ? 'selected' : '' }}>
                                Korlap
                            </option>
                        </select>
            ...
            <div
                ...
                <div class="w-full">
                    <label for="courier_ID" class="block w-fit mb-2 text-sm font-medium text-[#344357] dark:text-white">Nama
                        Pengguna</label>
                    <div
                        class="{{ $mode_insert == 'courier' ? '' : 'hidden' }} dropdown-input relative w-full mb-[10px] sm:mb-0 ring-1 ring-black overflow-hidden rounded-lg focus-within:ring-2 focus-within:ring-[#344357]">
                        <select
                            class="appearance-none w-full bg-white border-0 px-4 py-2 focus:ring-2 outline-none focus:ring-[#344357] overflow-hidden text-ellipsis pr-8 box-border"
                            name="courier_ID">
                ...
                <div class="w-full">
                    ...
                    <div class="relative">
                        <input type="text" id="username_courier" aria-describedby="helper-text-explanation"
                            class="{{ $mode_insert == 'courier' ? '' : 'hidden' }} border-0 ring-1 ring-[#344357] text-[#344357] text-sm rounded-lg focus:ring-2 focus:outline-none block w-full p-2.5"
                            placeholder="Johndoe321" name="username_courier" autocomplete="off" data-char-count
                            maxlength="100" value="{{ old('username_courier') }}">
            ...
            <div
                ...
                <div class="w-full {{ $mode_insert == 'courier' ? 'hidden' : '' }}">
                    <label for="username"
                        class="block w-fit mb-2 text-sm font-medium text-[#344357] dark:text-white">Username</label>
                    <div class="relative">
            ...
            {{-- Baris 3 --}}
            <div
                class="w-full flex flex-col sm:flex-row justify-between items-start space-y-8 sm:space-y-0 mt-8 {{ $mode_insert == 'courier' ? 'hidden' : '' }}">
